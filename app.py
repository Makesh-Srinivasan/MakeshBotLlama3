...
#     """
#     #### Contact me:
#     <p style='font-size: 14px;'>- <strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/makesh-srinivasan/">linkedin.com/in/makesh-srinivasan/</a></p>
#     <p style='font-size: 14px;'>- <strong>Email:</strong> makesh.srinivasan@nyu.edu</p>
...
# with st.sidebar.expander("Contact me!", expanded=False):
#     st.markdown("<h6 style='text-align: center;'>LinkedIn:<a href='https://www.linkedin.com/in/makesh-srinivasan/'>Connect!</a><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/LinkedIn_Logo.svg/1280px-LinkedIn_Logo.svg.png' alt='LinkedIn' class='inline-logo'></h6>", unsafe_allow_html=True)
    ...
    # st.session_state.maxlen_generation = st.slider("Max tokens 📝", value=st.session_state.maxtokens_default, step=20, max_value=2000, min_value=400, help="Maximum number of tokens you want to generate")
...
if prompt := st.chat_input("What does Makesh study?"):
    ...
    # Retreival
    retreived_contexts = get_relevant_contexts(prompt, top_k=10)
    
    custom_model_params = {"temperature": 0.2,"top_p": 0.25,"max_tokens": 2500,"stream": False}
